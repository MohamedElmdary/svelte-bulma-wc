...
<script lang="ts">
  ...
  export let flow: "up" | "down" | "right" | "left" = undefined
  $: assertIn(flow, ["up", "down", "right", "left"], "flow")

  onMount(initElement(host))
</script>

<div data-tooltip={tooltip} data-flow={flow || "up"}>
  <slot />
</div>

<style scoped>
  /* Copied from https://codepen.io/tutsplus/pen/WROvdG */
